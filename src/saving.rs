...
//  └─────────────────────────────────────────────────────┘
//
// Hierarchical (HAT) format ("HIE4")  — written by Hierarchical::save
//
//  ┌─────────────────────────────────────────────────────┐
//  │  HIER_MAGIC   u32   0x4849_4534  ("HIE4")           │
//  │  vocab_size   u32                                   │
//  │  context_size u32                                   │
//  │  n_boundaries u32                                   │
//  │  boundary_ids [u16 × n_boundaries]                  │
//  │  encoder      <Sequential blob>   (char model)      │
...
pub const HIER_MAGIC: u32 = 0x4849_4534;
